---
source_type: web
source_path: raw/web/2026-04-06-dontriskitawesome-ai-system-prompts 🧠 Curated collection of system prompts for top AI tools. Perfect for AI agent builders and prompt engineers. Incuding ChatGPT, Claude, Perplexity, Manus, Claude-Code, Loveable, v0, Grok, same new,.md
...
- 来源：`raw/web/2026-04-06-dontriskitawesome-ai-system-prompts 🧠 Curated collection of system prompts for top AI tools. Perfect for AI agent builders and prompt engineers. Incuding ChatGPT, Claude, Perplexity, Manus, Claude-Code, Loveable, v0, Grok, same new,.md`
- 主题：大语言模型
