...
![[raw/assets/attachments/computer-vision/145616-cb98523022feb4fc.png]]

效果图

- 文章地址：《 [A Neural Algorithm of Artistic Style](https://link.jianshu.com/?t=https://arxiv.org/abs/1508.06576) 》. arXiv:1508.06576
- Github链接： [https://github.com/jcjohnson/neural-style](https://link.jianshu.com/?t=https://github.com/jcjohnson/neural-style)

(转载请注明出处： [【译】A Neural Algorithm of Artistic Style (zhwhong)](https://www.jianshu.com/p/9f03b61fdeac) )

---

## 快读

![[raw/assets/attachments/computer-vision/145616-f446b39700e31e93.png]]

a图的style 和 p图的content 进行融合，得到第三幅图x

![[raw/assets/attachments/computer-vision/145616-7cf69d91f730fbee.png]]
...
![[raw/assets/attachments/computer-vision/145616-dc97ba42b9883975.png]]
...
根据这个式子关于图片x的梯度可以用标准差反向传播计算出来.因此我们可以改变原始的随机图片x直到它在特定的CNN的某层生成了和原始图片P相同的响应. The five content reconstructions in Fig 1 are from layers ‘conv1\_1’ (a), ‘conv2\_1’ (b), ‘conv3\_1’ (c), ‘conv4\_1’ (d) and ‘conv5\_1’(e) of the original VGG-Network.
...
El在更低层的导数可以很轻易地用标准差反向传播计算出来.图1中五个风格的重构是通过匹配在‘conv1\_1’ (a), ‘conv1\_1’ and ‘conv2\_1’(b), ‘conv1\_1’, ‘conv2\_1’ and ‘conv3\_1’(c),‘ conv1\_1’, ‘conv2\_1’, ‘conv3\_1’ and ‘conv4\_1’ (d),‘conv1\_1’, ‘conv2\_1’, ‘conv3\_1’, ‘conv4\_1’ and ‘conv5\_1’ (e)的风格表现生成的.
...
(注：感谢您的阅读，希望本文对您有所帮助。如果觉得不错欢迎分享转载，但请先点击 [这里](https://link.jianshu.com/?t=https://101705160006292.bqy.mobi/) 获取授权。本文由 [版权印](https://link.jianshu.com/?t=https://www.banquanyin.com/) 提供保护，禁止任何形式的未授权违规转载，谢谢！)