...
A new major release, [FFmpeg 8.0 "Huffman"](https://ffmpeg.org/download.html#release_8.0), is now available for download. Thanks to several delays, and modernization of our entire infrastructure, this release ended up being one of our largest releases to date. In short, its new features are:
...
Decoders use the same hwaccel API and commands, so users do not need to do anything special to enable them, as enabling [Vulkan decoding](https://trac.ffmpeg.org/wiki/HWAccelIntro#Vulkan) is sufficient to use them.  
Encoders, like our hardware accelerated encoders, require specifying a new encoder (ffv1\_vulkan). Currently, the only codecs supported are: FFv1 (encoding and decoding) and ProRes RAW (decode only). ProRes (encode+decode) and VC-2 (encode+decode) implementations are complete and currently in review, to be merged soon and available with the next minor release.  
...
The project has recently started to modernize its infrastructure. Our mailing list servers have been fully upgraded, and we have recently started to accept contributions via a new forge, available on [code.ffmpeg.org](https://code.ffmpeg.org/), running a Forgejo instance.
...
[FFmpeg 7.1 "Péter"](https://ffmpeg.org/download.html#release_7.1), a new major release, is now available! A full list of changes can be found in the release [changelog](https://git.ffmpeg.org/gitweb/ffmpeg.git/blob/refs/heads/release/7.1:/Changelog).
...
The number of issues FFmpeg has in [Coverity (a static analyzer)](https://scan.coverity.com/projects/ffmpeg) is now lower than it has been since 2016. Our defect density is less than one 30th of the average in OSS with over a million code lines. All this was possible thanks to a grant from the [Sovereign Tech Fund](https://www.sovereigntechfund.de/).

![[coverity-lifetime-2024-08.png|Coverity Lifetime Graph till 2024-08]]
...
A new major release, [FFmpeg 7.0 "Dijkstra"](https://ffmpeg.org/download.html#release_7.0), is now available for download. The most noteworthy changes for most users are a [native VVC decoder](#vvcdec) (currently experimental, until more fuzzing is done), [IAMF support](#iamf), or a [multi-threaded `ffmpeg` CLI tool](#cli_threading).
...
[FFmpeg 6.1 "Heaviside"](https://ffmpeg.org/download.html#release_6.1), a new major release, is now available! Some of the highlights:
...
- ffmpeg -shortest\_buf\_duration option
...
- ffmpeg CLI new options: -stats\_enc\_pre\[\_fmt\], -stats\_enc\_post\[\_fmt\], -stats\_mux\_pre\[\_fmt\]
- hstack\_vaapi, vstack\_vaapi and xstack\_vaapi filters
- XMD ADPCM decoder and demuxer
- media100 to mjpegb bsf
- ffmpeg CLI new option: -fix\_sub\_duration\_heartbeat
- WavArc decoder and demuxer
- CrystalHD decoders deprecated
- SDNS demuxer
- RKA decoder and demuxer
- filtergraph syntax in ffmpeg CLI now supports passing file contents as option values
- hstack\_qsv, vstack\_qsv and xstack\_qsv filters

We strongly recommend users, distributors, and system integrators to upgrade unless they use current git master.

### July 22nd, 2022, FFmpeg 5.1 "Riemann"

[FFmpeg 5.1 "Riemann"](https://ffmpeg.org/download.html#release_5.1), a new major release, is now available! Some of the highlights:
...
- libplacebo filter
- vflip\_vulkan, hflip\_vulkan and flip\_vulkan filters
- adynamicequalizer audio filter
- yadif\_videotoolbox filter
...
[FFmpeg 4.4 "Rao"](https://ffmpeg.org/download.html#release_4.4), a new major release, is now available! Some of the highlights:
...
[FFmpeg 4.3 "4:3"](https://ffmpeg.org/download.html#release_4.3), a new major release, is now available! Some of the highlights:
...
- Vulkan support
- avgblur\_vulkan, overlay\_vulkan, scale\_vulkan and chromaber\_vulkan filters
...
[FFmpeg 4.2 "Ada"](https://ffmpeg.org/download.html#release_4.2), a new major release, is now available! Some of the highlights:
...
[FFmpeg 4.1 "al-Khwarizmi"](https://ffmpeg.org/download.html#release_4.1), a new major release, is now available! Some of the highlights:
...
[FFmpeg 4.0 "Wu"](https://ffmpeg.org/download.html#release_4.0), a new major release, is now available! Some of the highlights:
...
- Add android\_camera indev
- codec2 en/decoding via libcodec2
- native SBC encoder and decoder
- drmeter audio filter
- hapqa\_extract bitstream filter
- filter\_units bitstream filter
...
[FFmpeg 3.4 "Cantor"](https://ffmpeg.org/download.html#release_3.4), a new major release, is now available! Some of the highlights:
...
- afir audio filter
- scale\_cuda CUDA based video scale filter
...
[FFmpeg 3.3 "Hilbert"](https://ffmpeg.org/download.html#release_3.3), a new major release, is now available! Some of the highlights:
...
[FFmpeg 3.1.2](https://ffmpeg.org/download.html#release_3.1), a new point release from the 3.1 release branch, is now available! It fixes several bugs.
...
[FFmpeg 3.1.1](https://ffmpeg.org/download.html#release_3.1), a new point release from the 3.1 release branch, is now available! It mainly deals with a few ABI issues introduced in the previous release.
...
[FFmpeg 3.1 "Laplace"](https://ffmpeg.org/download.html#release_3.1), a new major release, is now available! Some of the highlights:
...
[FFmpeg 3.0 "Einstein"](https://ffmpeg.org/download.html#release_3.0), a new major release, is now available! Some of the highlights:

- [The native FFmpeg AAC encoder has seen extensive improvements and is no longer considered experimental](#aac_encoder_stable)
- [Removed support for libvo-aacenc and libaacplus](#removing_external_aac_encoders)
...
We have made several new point releases (**[2.8.5](https://ffmpeg.org/download.html#release_2.8), [2.7.5](https://ffmpeg.org/download.html#release_2.7), [2.6.7](https://ffmpeg.org/download.html#release_2.6), [2.5.10](https://ffmpeg.org/download.html#release_2.5)**). They fix various bugs, as well as CVE-2016-1897 and CVE-2016-1898. Please see the changelog for each release for more details.
...
We published release **[2.8](https://ffmpeg.org/download.html#release_2.8)** as new major version. It contains all features and bug fixes of the git master branch from September 8th. Please see the **[changelog](https://raw.githubusercontent.com/FFmpeg/FFmpeg/release/2.8/Changelog)** for a list of the most important changes.
...
We have made a new major release (**[2.5](https://ffmpeg.org/download.html#release_2.5)**) It contains all features and bugfixes of the git master branch from the 4th December. Please see the **[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=release/2.5)** for a list of note-worthy changes.
...
We have made a new major release (**[2.4](https://ffmpeg.org/download.html#release_2.4)**) It contains all features and bugfixes of the git master branch from the 14th September. Please see the **[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=release/2.4)** for a list of note-worthy changes.

We recommend users, distributors and system integrators to upgrade unless they use current git master.

### August 20, 2014, FFmpeg 2.3.3, 2.2.7, 1.2.8

We have made several new point releases (**[2.3.3](https://ffmpeg.org/download.html#release_2.3), [2.2.7](https://ffmpeg.org/download.html#release_2.2), [1.2.8](https://ffmpeg.org/download.html#release_1.2)**). They fix various bugs, as well as CVE-2014-5271 and CVE-2014-5272. Please see the changelog for more details.
...
We have made a new major release (**[2.3](https://ffmpeg.org/download.html#release_2.3)**) It contains all features and bugfixes of the git master branch from the 16th July. Please see the **[Release Notes](http://git.videolan.org/?p=ffmpeg.git;a=blob;f=RELEASE_NOTES;hb=489d066)** for a list of note-worthy changes.
...
We have made several new point releases (**[2.2.4](https://ffmpeg.org/download.html#release_2.2), [2.1.5](https://ffmpeg.org/download.html#release_2.1), [2.0.5](https://ffmpeg.org/download.html#release_2.0), [1.2.7](https://ffmpeg.org/download.html#release_1.2), [1.1.12](https://ffmpeg.org/download.html#release_1.1), [0.10.14](https://ffmpeg.org/download.html#release_0.10)**). They fix a [security issue in the LZO implementation](http://blog.securitymouse.com/2014/06/raising-lazarus-20-year-old-bug-that.html), as well as several other bugs. See the git log for details.
...
We have made a new point releases (**[2.2.1](https://ffmpeg.org/download.html#release_2.2)**). It contains bug fixes for Tickets #2893, #3432, #3469, #3486, #3495 and #3540 as well as several other fixes. See the git log for details.

### March 24, 2014, FFmpeg 2.2

We have made a new major release (**[2.2](https://ffmpeg.org/download.html#release_2.2)**) It contains all features and bugfixes of the git master branch from 1st March. A partial list of new stuff is below:
...
We have made a new major release (**[2.1](https://ffmpeg.org/download.html#release_2.1)**) It contains all features and bugfixes of the git master branch from 28th October. A partial list of new stuff is below:
