...
published: 
created: 2026-04-06
description: "一年之前，初次接触 Transformer。当时只觉得模型复杂，步骤繁复，苦读论文多日也没有完全理解其中道理，只是泛泛地记住了一些名词，于其内部机理完全不通，相关公式更是过目便忘。 Self-Attention 是 Transformer…"
tags:
  - 
  - "clippings"
---
...
笔者刚开始接触 `Self-Attention` 时，最大的不理解的地方就是 `Q` `K` `V` 三个矩阵以及我们常提起的 [Query](https://zhida.zhihu.com/search?content_id=179413923&content_type=Article&match_order=1&q=Query&zhida_source=entity) 查询向量等等，现在究其原因，应当是被高维繁复的矩阵运算难住了，没有真正理解矩阵运算的核心意义。因此，在本文开始之前，笔者首先总结一些基础知识，文中会重新提及这些知识蕴含的思想是怎样体现在模型中的。
...
![[v2-da928d89f18a138c259cc42b7cc582cd_1440w.jpg]]

假如上面的公式很难理解，那么下面的公式读者能否知道其意义是什么呢？

$S o f t m a x \left(\right. X X^{T} \left.\right) X$
...
![[v2-f6973006b0ca2b67f452439698e6aacd_1440w.jpg]]
...
![[v2-179fd393b3aac244ec338767ef5d8d3d_1440w.jpg]]

我们回想Softmax的公式，Softmax操作的意义是什么呢？

![[v2-cdf70f87d0d540475c21051cbdd8ac33_1440w.jpg]]
...
![[v2-eca771a34e33a3ba86fbaebb48a4b818_1440w.jpg]]

我们仿佛已经拨开了一些迷雾，公式 已经理解了其中的一半。最后一个 X 有什么意义？完整的公式究竟表示什么？我们继续之前的计算，请看下图

![[v2-71069dfdaf4758a037bdddc56d2a5fc5_1440w.jpg]]
...
![[v2-f85c81cbb259b80c3644a16e005679be_1440w.jpg]]
...
![[v2-55d08f662a489739c3220486de095e12_1440w.jpg]]
...
class Self_Attention(nn.Module):
    ...
    def forward(self,x):
        ...
        return output
```
![[v2-3ac48b3ae8bc00ef88f639f342ad7acd_1440w.jpg]]

![[v2-d19efe6c82afff4f83946cb624aa409c_1440w.jpg]]
...
[docs.qq.com/doc/DWUtqcX](https://link.zhihu.com/?target=https%3A//docs.qq.com/doc/DWUtqcXJhVGJITUJr)

**简历修改 ｜ 拿个offer知识星球**

[docs.qq.com/doc/DWXJ0Sl](https://link.zhihu.com/?target=https%3A//docs.qq.com/doc/DWXJ0SlFMVE9DWVRj)

**本群特殊福利大额优惠券直接领：**

[https://t.zsxq.com/0a2frxDEK](https://link.zhihu.com/?target=https%3A//t.zsxq.com/0aR5ACY7z)

![[v2-448728c6943c8deeb5a751fd0fc01aa5_l.jpg]]
...
编辑于 2023-01-30 23:50・上海[注意力机制](https://www.zhihu.com/topic/20682987)[自然语言处理](https://www.zhihu.com/topic/19560026)[Transformer](https://www.zhihu.com/topic/20746363)
