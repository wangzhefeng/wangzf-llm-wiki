---
source_type:
source: "https://datawhalechina.github.io/easy-rl/#/chapter12/project3"
title: "项目三 使用 Policy-Based 方法实现 Pendulum-v0"
author:
published_at:
created_at: "2026-04-21T23:53:38+08:00"
topics: "Description"
tags:
  - "clippings"
related_concepts:
...
![[image-20200820174814084.png|image-20200820174814084]]
...
![[rewards_train 1.png|rewards_train]]

![[moving_average_rewards_train 1.png|moving_average_rewards_train]]

![[steps_train 1.png|steps_train]]

同时也可以绘制测试(eval)模型时的曲线：

![[rewards_eval 1.png|rewards_eval]]

![[moving_average_rewards_eval 1.png|moving_average_rewards_eval]]

![[steps_eval 1.png|steps_eval]]

也可以 [tensorboard](https://pytorch.org/docs/stable/tensorboard.html) 查看结果，如下：

![[image-20201015221602396.png|image-20201015221602396]]
