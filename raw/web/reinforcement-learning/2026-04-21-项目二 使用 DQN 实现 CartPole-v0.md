---
source_type:
source: "https://datawhalechina.github.io/easy-rl/#/chapter7/project2"
title: "项目二 使用 DQN 实现 CartPole-v0"
author:
published_at:
created_at: "2026-04-21T23:46:15+08:00"
topics: "Description"
tags:
  - "clippings"
related_concepts:
...
推荐使用Double-DQN去解决，即建立两个初始参数相同的全连接网络target\_net和policy\_net。
...
![[rewards_train.png|rewards_train]]

![[moving_average_rewards_train.png|moving_average_rewards_train]]

![[steps_train.png|steps_train]]

同时也可以绘制测试(eval)模型时的曲线：

![[rewards_eval.png|rewards_eval]]

![[moving_average_rewards_eval.png|moving_average_rewards_eval]]

![[steps_eval.png|steps_eval]]

也可以 [tensorboard](https://pytorch.org/docs/stable/tensorboard.html) 查看结果，如下：

![[image-20201015221032985.png|image-20201015221032985]]