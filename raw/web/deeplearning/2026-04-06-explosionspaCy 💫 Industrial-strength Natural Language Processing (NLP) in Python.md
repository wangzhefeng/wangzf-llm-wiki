...
- null
- clippings
title: 'explosion/spaCy: 💫 Industrial-strength Natural Language Processing (NLP) in
  Python'
topics:
- 深度学习
...
| [![Tailored Solutions](https://private-user-images.githubusercontent.com/13643239/289807341-36d2a42e-98c0-4599-90e1-788ef75181be.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..tSDifB07i1S9mTCWUQAQQNR3sorsk_5rg0pKKNiAfks)](https://explosion.ai/tailored-solutions) | Custom NLP consulting, implementation and strategic advice by spaCy’s core development team. Streamlined, production-ready, predictable and maintainable. Send us an email or take our 5-minute questionnaire, and well'be in touch! **[Learn more →](https://explosion.ai/tailored-solutions)** |
...
spaCy comes with an [extensive test suite](https://github.com/explosion/spaCy/blob/master/spacy/tests). In order to run the tests, you'll usually want to clone the repository and build spaCy from source. This will also install the required development dependencies and test utilities defined in the [`requirements.txt`](https://github.com/explosion/spaCy/blob/master/requirements.txt).

Alternatively, you can run `pytest` on the tests from within the installed `spacy` package. Don't forget to also install the test utilities via spaCy's [`requirements.txt`](https://github.com/explosion/spaCy/blob/master/requirements.txt):
