...
| [![[FP8-scheme.png|fp8_scheme]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/bitsandbytes/FP8-scheme.png) |
| --- |
...
| [![[lora-animated.gif|lora-gif]]](https://huggingface.co/datasets/trl-internal-testing/example-images/resolve/main/blog/133_trl_peft/lora-animated.gif) |
| --- |
...
| Model name | Half precision model size (in GB) | Hardware type / total VRAM | quantization method (CD=compute dtype / GC=gradient checkpointing / NQ=nested quantization) | batch\_size | gradient accumulation steps | optimizer | seq\_len | Result |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  |  |  |  |  |
| <10B scale models |  |  |  |  |  |  |  |  |
...
dacorvo, ybelkada, marcsun13

45

March 18, 2024

llmoptimizationquantization
...
[asd1asd1](https://huggingface.co/asd1asd1)

[Mar 7, 2025](#67ca86ac8e32b0571e17cacd)

hola

[liam255](https://huggingface.co/liam255)

[Dec 17, 2025](#694280ef331367968144857c)

•

[edited Feb 23](#694280ef331367968144857c "Edited by liam255")

Really cool insights! Makes me want to push the limits of my own chatbots. With CustomGPT.ai, I’ve been able to build bots that understand my content deeply and respond naturally. Seeing tools like QLoRA and 4-bit models makes advanced LLMs feel way more approachable for anyone experimenting