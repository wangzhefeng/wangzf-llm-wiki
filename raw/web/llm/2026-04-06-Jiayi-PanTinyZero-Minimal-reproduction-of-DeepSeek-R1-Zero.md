...
description: Minimal reproduction of DeepSeek R1-Zero. Contribute to Jiayi-Pan/TinyZero
...
> **⚠️ Deprecation Notice:** This repo is no longer actively maintained. For running RL experiments, please directly use the latest [veRL](https://github.com/volcengine/verl) library. For the archived original documentation, see [OLD\_README.md](https://github.com/Jiayi-Pan/TinyZero/blob/main/OLD_README.md).
