---
source_type: web
title: "Lightning-AI/litgpt: 20+ high-performance LLMs with recipes to pretrain, finetune and deploy at scale."
author: 
...
[Quick start](#quick-start) • [Models](#choose-from-20-llms) • [Finetune](#finetune-an-llm) • [Deploy](#deploy-an-llm) • [All workflows](#all-workflows) • [Features](#state-of-the-art-features) • [Recipes (YAML)](#training-recipes) • [Lightning AI](https://lightning.ai/) • [Tutorials](#tutorials)
...
[Explore the full Python API docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/python-api.md).
...
[Finetune](#finetune-an-llm) • [Pretrain](#pretrain-an-llm) • [Continued pretraining](#continue-pretraining-an-llm) • [Evaluate](#evaluate-an-llm) • [Deploy](#deploy-an-llm) • [Test](#test-an-llm)
...
[Read the full finetuning docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune.md)
...
[Read the full deploy docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/deploy.md).
...
[Read the full evaluation docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/evaluation.md).
...
The download of certain models requires an additional access token. You can read more about this in the [download](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/download_model_weights.md#specific-models-and-access-tokens) documentation.

[Read the full chat docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/inference.md).
...
[Read the full pretraining docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/pretrain.md)
...
[Read the full continued pretraining docs](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/pretrain.md#continued-pretraining-on-custom-data)

---

## State-of-the-art features

✅ State-of-the-art optimizations: Flash Attention v2, multi-GPU support via fully-sharded data parallelism, [optional CPU offloading](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/oom.md#do-sharding-across-multiple-gpus), and [TPU and XLA support](https://github.com/Lightning-AI/litgpt/blob/main/extensions/xla).  
✅ [Pretrain](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/pretrain.md), [finetune](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune.md), and [deploy](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/inference.md)  
✅ Reduce compute requirements with low-precision settings: FP16, BF16, and FP16/FP32 mixed.  
✅ Lower memory requirements with [quantization](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/quantize.md): 4-bit floats, 8-bit integers, and double quantization.  
✅ [Configuration files](https://github.com/Lightning-AI/litgpt/blob/main/config_hub) for great out-of-the-box performance.  
✅ Parameter-efficient finetuning: [LoRA](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune_lora.md), [QLoRA](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune_lora.md), [Adapter](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune_adapter.md), and [Adapter v2](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune_adapter.md).  
✅ [Exporting](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/convert_lit_models.md) to other popular model weight formats.  
✅ Many popular datasets for [pretraining](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/pretrain.md) and [finetuning](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/prepare_dataset.md), and [support for custom datasets](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/prepare_dataset.md#preparing-custom-datasets-for-instruction-finetuning).  
...
Browse all training recipes [here](https://github.com/Lightning-AI/litgpt/blob/main/config_hub).
...
🚀 [Get started](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/0_to_litgpt.md)  
⚡️ [Finetuning, incl. LoRA, QLoRA, and Adapters](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/finetune.md)  
🤖 [Pretraining](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/pretrain.md)  
💬 [Model evaluation](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/evaluation.md)  
📘 [Supported and custom datasets](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/prepare_dataset.md)  
🧹 [Quantization](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/quantize.md)  
🤯 [Tips for dealing with out-of-memory (OOM) errors](https://github.com/Lightning-AI/litgpt/blob/main/tutorials/oom.md)  
🧑🏽💻 [Using cloud TPUs](https://github.com/Lightning-AI/litgpt/blob/main/extensions/xla)  
