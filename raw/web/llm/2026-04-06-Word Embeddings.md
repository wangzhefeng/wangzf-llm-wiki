...
![[assets/attachments/llm/word_repr_intro-min.png]]
...
![[assets/attachments/llm/lookup_table.gif]]
...
![[assets/attachments/llm/unk_in_voc-min.png]]
...
![[assets/attachments/llm/one_hot-min.png]]
...
![[assets/attachments/llm/idea-min.png]]
...
![[assets/attachments/llm/window-min.png]]
...
![[assets/attachments/llm/define_ppmi-min.png]]
...
![[assets/attachments/llm/lsa-min.png]]
...
![[assets/attachments/llm/intro-min.png]]
...
![[assets/attachments/llm/loss_with_the_plan-min.png]]
...
![[assets/attachments/llm/two_vocs_with_theta-min.png]]
...
![[assets/attachments/llm/prob_o_c-min.png]]  
...
![[assets/attachments/llm/sent_cat_central-min.png]]
...
![[assets/attachments/llm/one_step_alg-min.png]]

  
  
![[assets/attachments/llm/loss_intuition-min.png]]
...
![[assets/attachments/llm/negative_sampling-min.png]]
...
![[assets/attachments/llm/cbow_skip-min.png]]
...
![[assets/attachments/llm/idea-min 1.png]]
...
![[assets/attachments/llm/glove_loss-min.png]]
...
![[assets/attachments/llm/intrinsic_evaluation-min.png]]
...
![[assets/attachments/llm/extrinsic_evaluation-min.png]]
...
![[assets/attachments/llm/evaluation_tradeoff-min.png]]
...
![[assets/attachments/llm/frog-min.png]]  
...
![[assets/attachments/llm/rare_words-min.png]]  
...
![[assets/attachments/llm/king_example-min.png]]
...
![[assets/attachments/llm/examples_both-min.png]]
...
![[assets/attachments/llm/analogy_task_v2-min.png]]

![[assets/attachments/llm/analogy_testset-min.png]]  
...
![[assets/attachments/llm/cross_lingual_matching-min.png]]
...
![[assets/attachments/llm/counts_simple-min.png]]

---

? Are context words at different distances equally important? If not, how can we modify co-occurrence counts?  
Possible answers ![[assets/attachments/llm/counts_modify_position-min.png]] Intuitively, words that are closer to the central are more important; for example, immediate neighbors are more informative than words at distance 3.  
...
? In language, word order is important; specifically, left and right contexts have different meanings. How can we distinguish between the left and right contexts? One of the existing approaches ![[assets/attachments/llm/counts_left_right-min.png]] Here the weighting idea we saw above would not work: we can not say which contexts, left or right, are more important.  
...
![[assets/attachments/llm/cat_5windows-min.png]]
...
![[assets/attachments/llm/freq_subsampling_idea-min.png]]
...
![[assets/attachments/llm/w2v_position-min.png]] As in [the previous exercise on count-based methods](#research_improve_count_based), we can assign higher weights to the words which are closer to the central.  
...
![[assets/attachments/llm/distinct_vectors-min.png]]
...
![[assets/attachments/llm/fasttext-min.png]]
...
![[assets/attachments/llm/semantic_change-min.png]]
...
![[assets/attachments/llm/intersect_neighbors-min.png]] A very simple approach is to train embeddings (e.g., Word2Vec) and look at the closest neighbors. If a word's closest neighbors are different for the two corpora, the word changed its meaning: remember that word embeddings reflect contexts they saw!  
...
![[assets/attachments/llm/emb_align-min.png]]
