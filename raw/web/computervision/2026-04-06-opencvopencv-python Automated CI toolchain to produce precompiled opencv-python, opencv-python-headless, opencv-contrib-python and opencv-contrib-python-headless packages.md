...
A: Non-free algorithms such as SURF are not included in these packages because they are patented / non-free and therefore cannot be distributed as built binaries. Note that SIFT is included in the builds due to patent expiration since OpenCV versions 4.3.0 and 3.4.10. See this issue for more info: [#126](https://github.com/opencv/opencv-python/issues/126)
...
See this issue for more discussion: [#424](https://github.com/opencv/opencv-python/issues/424)
...
Starting from version 4.7.0 the Mac OS GitHub Actions build environment was update to version 11. Mac OS 10.x support deprecated. See [actions/runner-images#5583](https://github.com/actions/runner-images/issues/5583)
