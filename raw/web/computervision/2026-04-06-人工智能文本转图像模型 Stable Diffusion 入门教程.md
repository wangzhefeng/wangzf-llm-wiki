...
![[raw/assets/attachments/computervision/v2-43d12e3b3bc9d19ce35a2c7b5d9459a7_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-8979286536038b4d3ca96feeeb26f1de_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-f3ffaf71f8ec1574e555594fe113d8ff_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-46d4f038ae9a21454cb75e04654320df_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-14353fa103e4c4d54868a49bda09e1bc_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-a5899a9ba5c4c0504656734f9988f55b_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-c028a2b815b257b8355e9bd810345800_1440w.jpg]]

![[raw/assets/attachments/computervision/v2-421f5c4807d2b0380561c630543809ec_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-4131cf1a01afb4d430503091f259c57b_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-94e0744cc44c8ea12f6bcd7f91f55b21_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-324a1f4a8d4f2b17769732d19251e2bc_1440w.jpg]]

04.6. 点击「代码执行程序」选择「 **全部运行** 」。

![[raw/assets/attachments/computervision/v2-d9149adc7f3d69ab7dd105dac4d579d3_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-3aaaac5ded9b533798fb3a6e947c8234_1440w.jpg]]

04.12. 在如图位置 **输入prompt** （描述文本）， **设置** 好图片 **尺寸** 和生成图片 **张数** ，其他建议按默认值， **点击** 「 **Generate** 」就开始生成了。

![[raw/assets/attachments/computervision/v2-4e2060c6703126ca8f416cb24d0c78d2_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-e6dd2b33b4e73ae0a1a7759d55f18992_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-82bf605e509fe9a1b72c1bdbf80826f0_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-6b7cacb249379b7f7d00328b15452558_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-76941eec4575000874da4c97f9710404_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-a8b4ae6753e47cf69df046a236ff3f43_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-f708c7555f3e7769cb17d40db0ac9b4c_1440w.jpg]]

05.5. **修改** 文件夹 **名称** 、 **步数** 、生成图片 **张数** 等参数， **输入描述文本** 。

![[raw/assets/attachments/computervision/v2-6bcae853daed9766254f1356f12775ad_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-68cf801f8b3bb264828c754b75cb642f_1440w.jpg]]

05.12. 任务完成后会在此处显示，若一次生成了多张图片会依次在此显示，全部完成后会显示最后一张图片。

![[raw/assets/attachments/computervision/v2-535aa1cf0e755172ad8e90f1ef201473_1440w.jpg]]
...
![[raw/assets/attachments/computervision/v2-af3326b005cc5984f16249b3836c17f2_1440w.jpg]]

05.15. **点击** 文件窗口上方第一个「 **上传到会话存储空间** 」 **图标** ，选择你要上传的图片并点击「打开」，图片就会开始上传（你也可以把图片直接拖进文件窗口的空白处）。

![[raw/assets/attachments/computervision/v2-5ae1590897a508596403ab9b4de65d4c_1440w.jpg]]

05.16. 上传完成后图片会显示在文件窗口的列表中，找到你要使用的图片并 **点击** 文件名后方的 **三个小圆点** ，选择「 **复制路径** 」。

![[raw/assets/attachments/computervision/v2-624b2ad24709ad13cb57becd5f66f245_1440w.jpg]]

05.17. **将路径粘贴在如图位置，设置 init\_strength 等参数，** 点击「代码执行程序」选择「 **全部运行** 」，如果之前已经运行过程序，直接点击 **Image creation** 单元前面的圆形按钮即可。

![[raw/assets/attachments/computervision/v2-8802efb9b519feec31919f214943d1b5_1440w.png]]
