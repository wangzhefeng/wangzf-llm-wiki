...
In the process, we introduce how to perform periodic feature engineering using the [`sklearn.preprocessing.SplineTransformer`](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.SplineTransformer.html#sklearn.preprocessing.SplineTransformer "sklearn.preprocessing.SplineTransformer") class and its `extrapolation="periodic"` option.
...
![[sphx_glr_plot_cyclical_feature_engineering_001.png|Average hourly bike demand during the week]]
...
![[sphx_glr_plot_cyclical_feature_engineering_002.png|plot cyclical feature engineering]]
...
If the time information was only present as a date or datetime column, we could have expanded it into hour-in-the-day, day-in-the-week, day-in-the-month, month-in-the-year using pandas: [https://pandas.pydata.org/pandas-docs/stable/user\_guide/timeseries.html#time-date-components](https://pandas.pydata.org/pandas-docs/stable/user_guide/timeseries.html#time-date-components)
...
As usual for linear models, categorical variables need to be one-hot encoded. For consistency, we scale the numerical features to the same 0-1 range using [`MinMaxScaler`](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.MinMaxScaler.html#sklearn.preprocessing.MinMaxScaler "sklearn.preprocessing.MinMaxScaler"), although in this case it does not impact the results much because they are already on comparable scales:
...
However, this introduces a very large number of new features. If the time of the day was represented in minutes since the start of the day instead of hours, one-hot encoding would have introduced 1440 features instead of 24. This could cause some significant overfitting. To avoid this we could use [`sklearn.preprocessing.KBinsDiscretizer`](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.KBinsDiscretizer.html#sklearn.preprocessing.KBinsDiscretizer "sklearn.preprocessing.KBinsDiscretizer") instead to re-bin the number of levels of fine-grained ordinal or numerical variables while still benefitting from the non-monotonic expressivity advantages of one-hot encoding.
...
![[sphx_glr_plot_cyclical_feature_engineering_003.png|Trigonometric encoding for the 'hour' feature]]
...
![[sphx_glr_plot_cyclical_feature_engineering_004.png|plot cyclical feature engineering]]
...
![[sphx_glr_plot_cyclical_feature_engineering_005.png|Periodic spline-based encoding for the 'hour' feature]]
...
![[sphx_glr_plot_cyclical_feature_engineering_006.png|Predictions by linear models]]
...
![[sphx_glr_plot_cyclical_feature_engineering_007.png|Predictions by non-linear regression models]]
...
![[sphx_glr_plot_cyclical_feature_engineering_008.png|Non-linear regression models]]
...
The `Nystroem` + `RidgeCV` regressor could also have been replaced by [`MLPRegressor`](https://scikit-learn.org/stable/modules/generated/sklearn.neural_network.MLPRegressor.html#sklearn.neural_network.MLPRegressor "sklearn.neural_network.MLPRegressor") with one or two hidden layers and we would have obtained quite similar results.
...
![[raw/assets/attachments/timeseries/sphx_glr_plot_time_series_lagged_features_thumb.png]]
...
![[raw/assets/attachments/timeseries/sphx_glr_plot_gradient_boosting_categorical_thumb.png]]
...
![[raw/assets/attachments/timeseries/sphx_glr_plot_polynomial_interpolation_thumb.png]]
...
![[raw/assets/attachments/timeseries/sphx_glr_plot_target_encoder_thumb.png]]
