...
[**\[Paper\]**](https://openreview.net/pdf?id=cGDAkQo1C0p) [**\[Project page\]**](https://seharanul17.github.io/RevIN/)

[![[raw/assets/attachments/timeseries/fig1.gif]]](https://github.com/ts-kim/RevIN/blob/master/fig1.gif)
...
[![[raw/assets/attachments/timeseries/qual.png]]](https://github.com/ts-kim/RevIN/blob/master/qual.png)
...
- x\_in: (batch\_size, sequence\_length, num\_features)
- x\_out: (batch\_size, prediction\_length, num\_features)
