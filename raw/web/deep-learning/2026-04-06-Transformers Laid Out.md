...
author:
published_at: "2025-01-03T06:30:00+00:00"
created_at: "2026-04-17T11:28:54+08:00"
topics: "I have encountered that there are mainly three types of blogs/videos/tutorials talking about transformers"
tags:
  - "clippings"
related_concepts:
status: "inbox"
...
![[raw/assets/attachments/1.png|Image of a transformer]]
...
![[raw/assets/attachments/2.png|Image of Encoders and Decoders]]
...
![[raw/assets/attachments/4.png|Image of an encoder]]
...
![[7.png|Image of creating Q,K,V vectors]]
...
![[8.png|Image of a self-attention mechanism in the form of vectors]]
...
![[9.png|Image of calculating Q,K,V matrix]]

Second calculate the attention scores

![[10.png|Image of calculating attention scores using matrix]]

Third repeat the steps for each attention head

![[11.png|Image of calculating attention scores for different heads]]

This is the how the output from each attention head will look like

![[12.png|Image of output of different attention heads]]
...
![[13.png|Image of joining attention scores]]

Here is a summary of everything that is going on

![[14.png|Image of summary of attention calculation]]
...
![[raw/assets/attachments/SA.png|Image of different representation for different words]]
...
![[raw/assets/attachments/3.png|Image of encoders and decoders]]
...
![[raw/assets/attachments/encoder.png|Image of an encoder]]
...
![[19.png|Image of an encoder broken down]]
