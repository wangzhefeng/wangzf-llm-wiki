...
topics:
- 深度学习
source_url: https://zhang-each.github.io/My-CS-Notebook/CS224N/Stanford-CS224N-Assignment1%262/#assignment1word-vectors
published_at: null
related_concepts: []
---
...
![[image-20211017204701251.png|image-20211017204701251]]
...
![[image-20211017205005816.png|image-20211017205005816]]
...
![[image-20211017205635225.png|image-20211017205635225]]
...
![[image-20211017212233547.png|image-20211017212233547]]
...
![[image-20211018123723707.png|image-20211018123723707]]

同时Word2Vec根据损失函数和目标的不同可以分成Naive-Softmax和负采样两种不同的实现方式

### Naive-Softmax形式

我们给每个单词定义了两个词向量，记作\\($u_{c} , v_{c}$ \\)，分别用来表示这个单词作为上下文和中心词时候的词向量，并用向量的点积和softmax定义指定中心词c的条件下单词o出现在上下文的概率分布，即：
...
而对于\\($u$ \\) 我们需要分成两种情况，首先是\\($u = u_{o}$ \\)的情况
...
![[image-20211018162013471.png|image-20211018162013471]]
