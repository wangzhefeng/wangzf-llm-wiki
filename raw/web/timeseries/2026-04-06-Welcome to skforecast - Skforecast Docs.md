...
published: 
created: 2026-04-06
description: "Python library for time series forecasting using machine learning models. It works with any estimator compatible with the scikit-learn API, including popular options like LightGBM, XGBoost, CatBoost, Keras, and many others."
tags:
  - 
  - "clippings"
---
