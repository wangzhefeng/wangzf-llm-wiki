...
topics:
  - "clippings"
status: inbox
source_url: "https://skywateryang.gitbook.io/timeseriesanalysis101"
published_at: 2021-08-29
related_concepts: []
---
鉴于时间序列数据的重要性，打算写一份时间序列的纯小白入门教程，从基本概念，EDA，再到各种模型，希望读者通过学习完这些章节能对时间序列数据分析有一个全面的了解。
...
[Next1. 概述](https://skywateryang.gitbook.io/timeseriesanalysis101/1111)
