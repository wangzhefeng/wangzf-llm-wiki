...
topics:
  - 待分类
status: inbox
source: "https://zhuanlan.zhihu.com/p/34587739"
published: 
created: 2026-04-06
description: "码字不易，欢迎点赞。前言2006年，NVIDIA公司发布了 CUDA，CUDA是建立在NVIDIA的CPUs上的一个通用并行计算平台和编程模型，基于CUDA编程可以利用GPUs的并行计算引擎来更加高效地解决比较复杂的计算难题。近年来，G…"
tags:
  - 
  - "clippings"
---
...
![[assets/attachments/uncategorized/v2-df49a98a67c5b8ce55f1a9afcf21d982_1440w.jpg]]

基于CPU+GPU的异构计算. 来源：Preofessional CUDA® C Programming

可以看到GPU包括更多的运算核心，其特别适合数据并行的计算密集型任务，如大型矩阵运算，而CPU的运算核心较少，但是其可以实现复杂的逻辑运算，因此其适合控制密集型任务。另外，CPU上的线程是重量级的，上下文切换开销大，但是GPU由于存在很多核心，其线程是轻量级的。因此，基于CPU+GPU的异构计算平台可以优势互补，CPU负责处理逻辑复杂的串行程序，而GPU重点处理数据密集型的并行计算程序，从而发挥最大功效。

![[assets/attachments/uncategorized/v2-2959e07a36a8dc8f59280f53b43eb9d1_1440w.jpg]]
...
![[assets/attachments/uncategorized/v2-708897c8e1b627e3b08de922412a3347_1440w.jpg]]
...
```
![[assets/attachments/uncategorized/v2-aa6aa453ff39aa7078dde59b59b512d8_1440w.jpg]]
...
![[assets/attachments/uncategorized/v2-6456af75530956da6bc5bab7418ff9e5_1440w.jpg]]
...
![[assets/attachments/uncategorized/v2-dcc0f678850d5bf1683753c34ca4b308_1440w.jpg]]
...
![[assets/attachments/uncategorized/v2-e4258399e69394620daa1e199d53fe0e_1440w.jpg]]
...
```
![[assets/attachments/uncategorized/v2-9d9053c750be6fded195bfbff464e5a1_1440w.jpg]]
...
编辑于 2021-07-17 12:42[图形处理器（GPU）](https://www.zhihu.com/topic/19570894)[CUDA](https://www.zhihu.com/topic/19597236)[并行计算](https://www.zhihu.com/topic/19582194)