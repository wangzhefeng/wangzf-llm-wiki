...
View the notebook [`example_notebooks/arnet.ipynb`](https://github.com/ourownstory/AR-Net/blob/master/example_notebooks/01_fit_arnet.ipynb) for an example of how to use the model.
...
See file [`v0_1/example.py`](https://github.com/ourownstory/AR-Net/blob/master/v0_1/example.py) for how to use the v0.1 model.
