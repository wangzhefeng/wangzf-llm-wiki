...
published: 
created: 2026-04-06
description: "A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet. - fatedier/frp"
tags:
  - 
  - "clippings"
---
...
[README](https://github.com/fatedier/frp/blob/dev/README.md) | [中文文档](https://github.com/fatedier/frp/blob/dev/README_zh.md)
...
<sub>An open source, self-hosted alternative to public clouds, built for data ownership and privacy</sub>](https://github.com/beclab/Olares)
...
[![](https://private-user-images.githubusercontent.com/29792913/486708983-24670320-997d-4d62-9bca-955c59fe883d.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..x7VqSafQU3Joukug2lhQQf-RiHaLic5SEJfe8NmK2nA)  
**Requestly - Free & Open-Source alternative to Postman**  
<sub>All-in-one platform to Test, Mock and Intercept APIs.</sub>](https://requestly.com/?utm_source=github&utm_medium=partnered&utm_campaign=frp)
...
[![architecture](https://github.com/fatedier/frp/raw/dev/doc/pic/architecture.jpg)](https://github.com/fatedier/frp/blob/dev/doc/pic/architecture.jpg)
...
[Full configuration file for frps (Server)](https://github.com/fatedier/frp/blob/dev/conf/frps_full_example.toml)

[Full configuration file for frpc (Client)](https://github.com/fatedier/frp/blob/dev/conf/frpc_full_example.toml)
...
[![dashboard](https://github.com/fatedier/frp/raw/dev/doc/pic/dashboard.png)](https://github.com/fatedier/frp/blob/dev/doc/pic/dashboard.png)
...
Read the [document](https://github.com/fatedier/frp/blob/dev/doc/server_plugin.md).
...
Please refer to this [document](https://github.com/fatedier/frp/blob/dev/doc/ssh_tunnel_gateway.md) for more information.
...
For detailed information about configuration and usage, please refer to the [VirtualNet documentation](https://github.com/fatedier/frp/blob/dev/doc/virtual_net.md).
