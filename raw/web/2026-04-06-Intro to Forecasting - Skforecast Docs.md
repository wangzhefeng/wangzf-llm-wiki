...
![[assets/attachments/transform_timeseries.gif]]  
...
![[assets/attachments/matrix_transformation_with_exog_variable.png]]  
...
![[assets/attachments/diagram-trainig-forecaster.png]]  
...
![[assets/attachments/diagram-single-step-forecasting.png]]  
...
![[assets/attachments/diagram-recursive-mutistep-forecasting.png]]  
*Diagram of recursive multi-step forecasting*

![[recursive_forecasting_gif.gif]]  
...
![[assets/attachments/diagram-direct-multi-step-forecasting.png]]  
*Diagram of direct multi-step forecasting*

![[direct_forecasting_gif.gif]]  
*Direct forecasting*
...
![[assets/attachments/forecaster_multi_series_train_matrix_diagram.png]]  
...
![[assets/attachments/forecaster_multi_series_prediction_diagram.png]]  
...
![[assets/attachments/forecaster_multivariate_train_matrix_diagram.png]]  
...
![[assets/attachments/diagram-backtesting-no-refit.png]]

![[assets/attachments/backtesting_no_refit.gif]]  
*Backtesting without refit*
...
![[assets/attachments/diagram-backtesting-refit.png]]

![[assets/attachments/backtesting_refit.gif]]  
*Backtesting with refit and increasing training size (fixed origin)*
...
![[assets/attachments/diagram-backtesting-refit-fixed-train-size.png]]

![[assets/attachments/backtesting_refit_fixed_train_size.gif]]  
*Backtesting with refit and fixed training size (rolling origin)*
...
![[assets/attachments/backtesting_refit_gap.gif]]  
