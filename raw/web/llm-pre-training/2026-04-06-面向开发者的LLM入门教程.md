...
tags:
  - 
  - "clippings"
source_url: "https://datawhalechina.github.io/llm-cookbook/#/"
published_at: null
related_concepts: []
topics:
  - llm-pre-training
...
![figures/C0/readme.jpg](https://datawhalechina.github.io/llm-cookbook/figures/C0/readme.jpg)
...
4. 特别感谢以下为教程做出贡献的同学！
[![](https://contrib.rocks/image?repo=datawhalechina/llm-cookbook)](https://datawhalechina.github.io/llm-cookbook/graphs/contributors)
...
![](https://datawhalechina.github.io/llm-cookbook/figures/qrcode.jpeg) Datawhale 是一个专注于数据科学与 AI 领域的开源组织，汇集了众多领域院校和知名企业的优秀学习者，聚合了一群有开源精神和探索精神的团队成员。微信搜索公众号 Datawhale 可以加入我们。
