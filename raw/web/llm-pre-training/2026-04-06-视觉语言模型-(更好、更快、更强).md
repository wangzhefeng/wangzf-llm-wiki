...
source_url: https://huggingface.co/blog/zh/vlms-2025
...
[在 GitHub 上更新](https://github.com/huggingface/blog/blob/main/zh/vlms-2025.md)

本文也提供英文版本 [English](https://huggingface.co/blog/vlms-2025) 。

## 动机

视觉语言模型 (VLMs) 正成为热门话题。在 [一篇之前的博客文章](https://huggingface.co/blog/vlms) ( *2024 年 4 月* ) 中，我们详细讨论了 VLMs。其中很大一部分内容是关于 [LLaVA](https://huggingface.co/papers/2304.08485) ，它是第一个 **成功** 且 **易于复现** 的开源视觉语言模型，同时还提供了如何发现、评估和微调开源模型的技巧。
...
- [新的模型趋势](#%E6%96%B0%E7%9A%84%E6%A8%A1%E5%9E%8B%E8%B6%8B%E5%8A%BF)
	- [任意模态互转模型](#%E4%BB%BB%E6%84%8F%E6%A8%A1%E6%80%81%E4%BA%92%E8%BD%AC%E6%A8%A1%E5%9E%8B)
		- [推理模型](#%E6%8E%A8%E7%90%86%E6%A8%A1%E5%9E%8B)
		- [轻量级强力模型](#%E8%BD%BB%E9%87%8F%E7%BA%A7%E5%BC%BA%E5%8A%9B%E6%A8%A1%E5%9E%8B)
		- [混合专家解码器](#%E6%B7%B7%E5%90%88%E4%B8%93%E5%AE%B6%E8%A7%A3%E7%A0%81%E5%99%A8)
		- [视觉语言动作模型](#%E8%A7%86%E8%A7%89%E8%AF%AD%E8%A8%80%E5%8A%A8%E4%BD%9C%E6%A8%A1%E5%9E%8B)
- [专业能力](#%E4%B8%93%E4%B8%9A%E8%83%BD%E5%8A%9B)
	- [使用视觉语言模型进行目标检测、分割和计数](#%E4%BD%BF%E7%94%A8%E8%A7%86%E8%A7%89%E8%AF%AD%E8%A8%80%E6%A8%A1%E5%9E%8B%E8%BF%9B%E8%A1%8C%E7%9B%AE%E6%A0%87%E6%A3%80%E6%B5%8B%E5%88%86%E5%89%B2%E5%92%8C%E8%AE%A1%E6%95%B0)
		- [多模态安全模型](#%E5%A4%9A%E6%A8%A1%E6%80%81%E5%AE%89%E5%85%A8%E6%A8%A1%E5%9E%8B)
		- [多模态 RAG: 检索器和重排器](#%E5%A4%9A%E6%A8%A1%E6%80%81-RAG-%E6%A3%80%E7%B4%A2%E5%99%A8%E5%92%8C%E9%87%8D%E6%8E%92%E5%99%A8)
- [多模态智能体](#%E5%A4%9A%E6%A8%A1%E6%80%81%E6%99%BA%E8%83%BD%E4%BD%93)
- [视频语言模型](#%E8%A7%86%E9%A2%91%E8%AF%AD%E8%A8%80%E6%A8%A1%E5%9E%8B)
- [视觉语言模型的新型对齐技术](#%E8%A7%86%E8%A7%89%E8%AF%AD%E8%A8%80%E6%A8%A1%E5%9E%8B%E7%9A%84%E6%96%B0%E5%9E%8B%E5%AF%B9%E9%BD%90%E6%8A%80%E6%9C%AF)
- [新基准](#%E6%96%B0%E5%9F%BA%E5%87%86)
	- [MMT-Bench](#mmt-bench)
		- [MMMU-Pro](#mmmu-pro)
- [附加: 我们的模型精选](#%E9%99%84%E5%8A%A0%E6%88%91%E4%BB%AC%E7%9A%84%E6%A8%A1%E5%9E%8B%E7%B2%BE%E9%80%89)
- [实用资源](#%E5%AE%9E%E7%94%A8%E8%B5%84%E6%BA%90)
...
[![[qwen-omni.png|Qwen-Omni]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/qwen-omni.png)
...
[![[kimi-vl.png|kimi-vl]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/kimi-vl.png)
...
混合专家 (MoEs) 模型为 **密集** ( **dense** ) 架构提供了一种 *替代方案* ，它通过动态选择和激活最相关的子模型 (称为 “专家”) 来处理给定的输入数据片段。这种选择性激活机制 (通过一个称为 “路由器” 的组件来完成选择) 已经被证明有潜力在利用更少计算资源的同时大幅提高模型性能和运行效率。
...
[![[pi0.png|pi0]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/pi0.png)
...
正如我们在前面的章节中看到的，VLM 可以对传统计算机视觉任务进行 *泛化* ( *generalization* )。模型现在可以接收图像和各种提示 (prompts)，如开放式文本，并输出带有定位标记 (localization tokens) (用于检测、分割等) 的结构化文本。
...
对于检测任务，模型输出边界框坐标作为 *token* 。而对于分割任务，模型输出检测 token 和分割 token。这些分割 token 并不是所有分割的像素坐标，而是由变分自编码器解码的编码本索引，该自编码器经过训练，可以将这些 token 解码为有效的分割掩码 (segmentation masks) (如下图所示)。

[![[pg2-seg.png|PaliGemma3]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/pg2-seg.png)
...
[![[molmo-pointing.png|molmo]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/molmo-pointing.png)

Qwen2.5-VL 也可以检测、指向和计数目标，这包括将 UI 元素也作为目标！

[![[qwen3-gui.png|Qwen2.5VL]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/qwen3-gui.png)
...
2025 年初，Google 推出了第一个开放多模态安全模型 [ShieldGemma 2](https://huggingface.co/google/shieldgemma-2-4b-it) 。它是在纯文本安全模型 ShieldGemma 的基础上构建的。该模型接收图像和内容策略，并返回图像是否符合给定策略的安全标准。 *策略* ( *Policy* ) 指的是图像不适当的标准。ShieldGemma 2 也可用于过滤图像生成模型的输出。
...
[![[llama-guard.png|Llama Guard 4]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/llama-guard.png)
...
传统的 PDF 解析器由多个元素组成，以保留文档中的结构和视觉元素，如 *布局* 、 *表格* 、 *图像* 、 *图表* ，所有这些都被渲染为 markdown。但这种设置可能难以维护。

[![[rag-1.png|传统解析]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/rag-1.png)

随着视觉语言模型的兴起，这个问题得到了解决: 现在有了多模态检索器和重排器。

[![[rag-2.png|多模态 RAG]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/rag-2.png)
...
[![[dse.png|DSE]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/dse.png)
...
[![[colpali.png|ColPali]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/colpali.png)
...
[![[video.png|视频 LMs]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/video.png)
...
[![[mrope.png|MRoPE]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/mrope.png)
...
[![[dpo.png|DPO]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/dpo.png)
...
一旦准备好数据集，你可以使用 trl 库中的 *DPOConfig* 和 *DPOTrainer* 类来配置和启动微调过程。
...
要使用 *DPOTrainer* 训练你的模型，你可以选择提供一个参考模型来计算奖励差异。如果你使用参数高效微调 (PEFT)，你可以通过设置 *ref\_model=None* 来省略参考模型。
...
[![[mmt-bench.png|MMT-Bench]]](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vlm2/mmt-bench.png)
...
## [nanoVLM: 最简洁、最轻量的纯 PyTorch 视觉-语言模型训练代码库](https://huggingface.co/blog/zh/nanovlm)

ariG23498, lusxvr, et. al.
...
## [SmolVLM 越变越小 —— 全新 250M 和 500M 模型正式发布！](https://huggingface.co/blog/zh/smolervlm)
